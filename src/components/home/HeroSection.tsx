    ...
    <section className="relative text-white py-20 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 max-w-6xl">
        <div className="flex flex-col items-center text-center mb-12">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-2 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          <Link href="/market" className="group">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/20 hover:bg-white/20 transition-all duration-300 h-full flex flex-col items-center text-center">
              ...
              <p className="text-white/80 mb-4">Buy and sell textbooks, supplies, and more</p>
          ...
          <Link href="/school-clubs" className="group">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/20 hover:bg-white/20 transition-all duration-300 h-full flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">School Clubs</h3>
              <p className="text-white/80 mb-4">Find and join student clubs and activities</p>
              <span className="text-white/90 group-hover:text-white flex items-center text-sm mt-auto">
          ...
          <Link href="/study-tools" className="group">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/20 hover:bg-white/20 transition-all duration-300 h-full flex flex-col items-center text-center">
              ...
              <p className="text-white/80 mb-4">Access resources and guides to improve your grades</p>
              <span className="text-white/90 group-hover:text-white flex items-center text-sm mt-auto">
          ...
          <Link href="/events" className="group">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/20 hover:bg-white/20 transition-all duration-300 h-full flex flex-col items-center text-center">
              ...
              <p className="text-white/80 mb-4">Stay updated on campus events and activities</p>
              <span className="text-white/90 group-hover:text-white flex items-center text-sm mt-auto">
        ...
        <div className="text-center">
          <Link href="/application-tips">
            <button className="h-12 rounded-md bg-white py-2 px-8 text-[#5f2995] text-base font-medium hover:bg-white/90 transition-colors focus:outline-none focus:ring-2 focus:ring-white/50 shadow-lg flex items-center mx-auto">
