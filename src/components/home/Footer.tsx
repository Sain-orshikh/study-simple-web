    ...
    <footer className="bg-gray-100 text-gray-700 py-10 border-t">
      <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2 text-gray-600 text-sm">
                ...
                <span>School Campus, Building 4</span>
              </li>
              <li className="flex items-center space-x-2 text-gray-600 text-sm">
                <MailIcon className="h-4 w-4 text-[#5f2995]" />
                <a href="mailto:contact@studysimple.edu" className="hover:text-[#5f2995]">
                  contact@studysimple.edu
                </a>
              </li>
              <li className="flex items-center space-x-2 text-gray-600 text-sm">
                <PhoneIcon className="h-4 w-4 text-[#5f2995]" />
                <span>(123) 456-7890</span>
              </li>
            </ul>
            <div className="flex space-x-3 pt-2">
              <a href="#" className="text-gray-400 hover:text-[#5f2995]">
        ...
        <div className="mt-10 pt-8 border-t border-gray-200 text-center">
          <p className="text-sm text-gray-500">
            Made with <HeartIcon className="inline-block h-4 w-4 text-[#ead36b]" /> for students, by students | Last updated: April 22, 2025
          </p>
        </div>
      </div>
    </footer>
