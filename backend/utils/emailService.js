...
export const sendSubscriptionConfirmation = async (email) => {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
      ...
      <p style="font-size: 16px; line-height: 1.5; color: #333;">
        If you want to check out our existing episodes, visit our <a href="http://localhost:3000/podcasts" style="color: #4F46E5; text-decoration: none; font-weight: bold;">podcast page</a>.
      </p>
      ...
      <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e0e0e0; font-size: 12px; color: #6B7280; text-align: center;">
        <p>
          ...
          <a href="http://localhost:3000/podcasts/unsubscribe?email=${encodeURIComponent(email)}" style="color: #4F46E5; text-decoration: none;">unsubscribe here</a>.
        </p>
